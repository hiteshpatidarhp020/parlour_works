  ...
  return (
    <>
      ...
      <Servicecard
        ...
        marginBottom="20px"
        labelOne="Hair Spa"
        labelTwo="Best salon in town"
        labelCTwoOne="Hair cut"
        labelCTwoTwo="Blow Dry"
        labelCTwoThree="Hair Spa"
        labelCTwoFour="Hair Dry"
        labelRightOne="F"
        labelRightTwo="F"
        labelRightThree="F"
        labelRightFour="M"
        ...
        labelRTFour="400"
      />
      {/*<PwImage src="/images/dashboard/hairspa.png" width="20%" height="20%" />*/}
