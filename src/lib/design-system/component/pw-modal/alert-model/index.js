...
const AlertmModal = (props) => {
  ...
  return (
    ...
    <div>
       ...
       <PwText  className="texttwoalert" text="be discarded" appearance="heading_s_medi"/>
       <PwSpace value="40px" />
       <PwButton width="130px" marginLeft="60px" onClick={handleCancel} label="Confirm" kind="secondary"/>
       <PwSpace value="30px" />
    </div>
    {/* <PwSpace value="100px" /> */}
